...
parser.add_argument("--exp", type=int, default=3, help="number of experiment")
...
for epoch in range(opt.n_epochs):
    for i, imgs in enumerate(EMNIST):
        ...
        if batches_done % opt.sample_interval == 0:
            ...
            save_image(syn_imgs.data[:25], "images/exp%d/%d_aux4syn.png" % (opt.exp, batches_done), nrow=5, normalize=True)
            save_image(real_imgs.data[:25], "images/exp%d/%d_ref4real.png" % (opt.exp, batches_done), nrow=5, normalize=True)
